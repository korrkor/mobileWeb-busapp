...
//        include_once ("gen.js");
        ...
        <div data-role = "page" id = "homepage" data-theme="a">
            ...
            <div  role = "main" class = "ui-content" style="background-color: gainsboro">
                <a id="admin_login" href="#"  onclick="redirect_login_page()" class="ui-btn ui-btn-inline">Login Admin</a>
...
//                
                ...
                <div data-role="popup" id="viewNames" class="ui-content"  data-iscroll>
                    ...
                    <a href="#" data-rel="back" data-role="button" data-theme="a" data-icon="delete" data-iconpos="notext" class="ui-btn-right">Close</a>
                    <ul  data-filter="true" data-filter-placeholder="Search fruits..." data-inset="true" data-role="listview">
