...
//        include_once ("gen.js");
        ...
        <div data-role = "page" id = "homepage" data-theme="a">
            ...
            <div  role = "main" class = "ui-content" style="background-color: gainsboro">
                <a id="admin_login" href="#" onclick="redirect_logout_admin()">Logout admin</a>
                ...
                <div data-role="collapsible-set">	
                    <div data-role="collapsible">	
                        ...
                        $reserve->fare_per_day("Monday");
                        $revenue = $reserve->fetch();
                        ...
                        echo"<br>";
                        echo"<br>";
                        echo "Total revenue:" . " " . $revenue['number'];
                        ?>
                        <br>
                    ...
                    <div data-role="collapsible">	
                        ...
                        $reserve2->fare_per_day("Tuesday");
                        $revenue2 = $reserve2->fetch();
                        ...
                        echo"<br>";
                        echo"<br>";
                        echo "Total revenue:" . " " . $revenue2['number'];
                        ?>
                        <br>
                        <a href="#viewNames"  onclick="names('Tuesday')" data-rel="popup" data-position-to="window" class="ui-btn ui-btn-inline">See people who have reserved</a>
                    </div>
                    <br>
                    ...
                    <div data-role="collapsible">	
                        ...
                        $reserve3->fare_per_day("Wednesday");
                        $revenue3 = $reserve3->fetch();
                        ...
                        echo"<br>";
                        echo"<br>";
                        echo "Total revenue:" . " " . $revenue3['number'];
                        ?>
                        <br>
                        <a href="#viewNames"  onclick="names('Wednesday')" data-rel="popup" data-position-to="window" class="ui-btn ui-btn-inline">See people who have reserved</a>
                    </div>
                    <br>
                    ...
                    <div data-role="collapsible">	
                        ...
                        $reserve4->fare_per_day("Thursday");
                        $revenue4 = $reserve4->fetch();
                        echo "Number of reserved seats:" . " " . $row_reserve4['number'];
                        echo"<br>";
                        echo"<br>";
                        echo "Number of seats available:" . " " . $seats_available4;
                        echo"<br>";
                        echo"<br>";
                        echo "Number of paid reservations:" . " " . $paid_row4['number'];
                        echo"<br>";
                        echo"<br>";
                        echo "Total revenue:" . " " . $revenue4['number'];
                        ?>	
                        <br>
                        <a href="#viewNames"  onclick="names('Thursday')" data-rel="popup" data-position-to="window" class="ui-btn ui-btn-inline">See people who have reserved</a>
                    </div>
                    <br>
                    ...
                    <div data-role="collapsible">	
                        ...
                        $reserve5->num_paid("Friday");
                        $paid_row5 = $reserve5->fetch();
                        $reserve5->fare_per_day("Friday");
                        $revenue5 = $reserve5->fetch();
                        ...
                        echo"<br>";
                        echo"<br>"; 
                        echo "Total revenue:" . " " . $revenue5['number'];
                        ?>
                        <br>
                        <a href="#viewNames"  onclick="names('Friday')" data-rel="popup" data-position-to="window" class="ui-btn ui-btn-inline">See people who have reserved</a>
                    </div>
                    <br>
                </div>
...
//                
                ...
                <div data-role="popup" id="viewNames" class="ui-content"  data-iscroll>
                    ...
                    <a href="#" data-rel="back" data-role="button" data-theme="a" data-icon="delete" data-iconpos="notext" class="ui-btn-right">Close</a>
                    <ul  data-filter="true" data-filter-placeholder="Search passengers" data-inset="true" data-role="listview">
